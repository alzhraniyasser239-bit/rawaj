...
const s = {
  ...
  sub: { color: '#6B5340', fontSize: 16, marginTop: 6 },

  platGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 14, marginBottom: 20 },
  platCard: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, padding: '26px 14px', background: theme.bgCard, border: `1px solid ${theme.border}`, borderRadius: 20, cursor: 'pointer', color: theme.text },
  ...
  backBtn: { padding: '9px 16px', borderRadius: 100, border: '1px solid rgba(58,42,28,0.2)', background: theme.bgCard, color: theme.textDim, fontSize: 14, fontWeight: 600 },
  crumbNow: { fontSize: 18, fontWeight: 800, color: '#5C4432' },

  typeRow: { display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 24 },
  typeChip: { padding: '9px 16px', borderRadius: 100, border: '1px solid rgba(58,42,28,0.2)', background: theme.bgCard, color: theme.textDim, fontSize: 14, fontWeight: 600, whiteSpace: 'nowrap' },
  ...
  cardCat: { display: 'inline-block', padding: '4px 10px', borderRadius: 100, background: 'rgba(201,169,97,0.2)', color: '#E8D5A8', fontSize: 12, fontWeight: 600 },
  ...
  priceNum: { fontSize: 20, fontWeight: 800, color: '#E8D5A8' },
  ...
  center: { textAlign: 'center', padding: '40px 0', color: '#6B5340', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 },
