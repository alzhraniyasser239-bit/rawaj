...
const s = {
  ...
  priceNum: { fontSize: 20, fontWeight: 800, color: '#7A5D33' },
  ...
  moreBtn: { padding: '13px 32px', borderRadius: 14, border: `1px solid ${theme.border}`, background: theme.bgCard, color: theme.text, fontSize: 15, fontWeight: 600 },
};
const m = {
  ...
  svcName: { padding: 14, background: 'rgba(156,122,69,0.12)', borderRadius: 12, fontSize: 14, lineHeight: 1.7, marginBottom: 14 },
  ...
  input: { width: '100%', boxSizing: 'border-box', padding: '13px 16px', marginBottom: 16, background: 'rgba(58,42,28,0.05)', border: `1px solid ${theme.border}`, borderRadius: 12, color: theme.text, fontSize: 15, outline: 'none' },
